...
api_instance = moosend.MailingListsApi()
...
body = moosend.CreatingACustomFieldRequest() # CreatingACustomFieldRequest | 
...
format = 'format_example' # str | 
apikey = 'apikey_example' # str | You may find your API Key or generate a new one in your account settings.
body = moosend.CreatingAMailingListRequest() # CreatingAMailingListRequest | 
...
apikey = 'apikey_example' # str | You may find your API Key or generate a new one in your account settings.
mailing_list_id = 'mailing_list_id_example' # str | The ID of the mailing list where the custom field belongs.
body = moosend.UpdatingACustomFieldRequest() # UpdatingACustomFieldRequest | 
...
body = moosend.UpdatingAMailingListRequest() # UpdatingAMailingListRequest | 
