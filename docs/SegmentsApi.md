...
api_instance = moosend.SegmentsApi()
...
body = moosend.AddingCriteriaToSegmentsRequest() # AddingCriteriaToSegmentsRequest | 
...
mailing_list_id = 'mailing_list_id_example' # str | The ID of the mailing list the specified segment belongs
apikey = 'apikey_example' # str | You may find your API Key or generate a new one in your account settings.
body = moosend.CreatingANewSegmentRequest() # CreatingANewSegmentRequest | 
...
apikey = 'apikey_example' # str | You may find your API Key or generate a new one in your account settings.
segment_id = 'segment_id_example' # str | The ID of the segment to update.
body = moosend.UpdatingASegmentRequest() # UpdatingASegmentRequest | 
...
body = moosend.UpdatingSegmentCriteriaRequest() # UpdatingSegmentCriteriaRequest | 
