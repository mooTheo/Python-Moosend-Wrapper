...
api_instance = moosend.SubscribersApi()
...
body = moosend.AddingMultipleSubscribersRequest() # AddingMultipleSubscribersRequest | 
...
apikey = 'apikey_example' # str | You may find your API Key or generate a new one in your account settings.
body = moosend.AddingSubscribersRequest() # AddingSubscribersRequest | 
...
body = moosend.RemovingASubscriberRequest() # RemovingASubscriberRequest | 
...
body = moosend.RemovingMultipleSubscribersRequest() # RemovingMultipleSubscribersRequest | 
...
format = 'format_example' # str | 
apikey = 'apikey_example' # str | You may find your API Key or generate a new one in your account settings.
body = moosend.UnsubscribingSubscribersFromAccountRequest() # UnsubscribingSubscribersFromAccountRequest | 
...
apikey = 'apikey_example' # str | You may find your API Key or generate a new one in your account settings.
mailing_list_id = 'mailing_list_id_example' # str | The ID of the mailing list to add subscribers to.
body = moosend.UnsubscribingSubscribersFromMailingListRequest() # UnsubscribingSubscribersFromMailingListRequest | 
...
apikey = 'apikey_example' # str | You may find your API Key or generate a new one in your account settings.
mailing_list_id = 'mailing_list_id_example' # str | The ID of the mailing list to remove the subscriber from.
body = moosend.UnsubscribingSubscribersFromMailingListAndASpecifiedCampaignRequest() # UnsubscribingSubscribersFromMailingListAndASpecifiedCampaignRequest | 
...
body = moosend.UpdatingASubscriberRequest() # UpdatingASubscriberRequest | 
