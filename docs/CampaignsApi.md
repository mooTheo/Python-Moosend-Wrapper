...
format = 'format_example' # str | 
apikey = 'apikey_example' # str | You may find your API Key or generate a new one in your account settings.
body = moosend.CreatingADraftCampaignRequest() # CreatingADraftCampaignRequest | 
...
body = moosend.SchedulingACampaignRequest() # SchedulingACampaignRequest | 
...
body = moosend.TestingACampaignRequest() # TestingACampaignRequest | 
...
apikey = 'apikey_example' # str | You may find your API Key or generate a new one in your account settings.
campaign_id = 'campaign_id_example' # str | The ID of the draft campaign to update.
body = moosend.UpdatingADraftCampaignRequest() # UpdatingADraftCampaignRequest | 
